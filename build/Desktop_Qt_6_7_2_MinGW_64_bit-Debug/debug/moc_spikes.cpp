...
struct qt_meta_stringdata_CLASSSpikesENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSpikesENDCLASS = QtMocHelpers::stringData(
    "Spikes"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSpikesENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Spikes::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSpikesENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSpikesENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSpikesENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *Spikes::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSpikesENDCLASS.stringdata0))
